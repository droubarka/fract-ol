...
/*   Updated: 2025/03/04 07:08:34 by mait-oub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "tricorn.h"

static int	tricorn_move(int keysym, t_fractal *fractal)
{
	int	scale_px;
...
static int	tricorn_iterations(int keysym, t_fractal *fractal)
{
	if (keysym == KEY_PLUS)
	{
...
static int	tricorn_reset(t_fractal *fractal)
{
...
int	tricorn_key(int keysym, t_fractal *fractal)
{
	...
	tricorn_move(keysym, fractal);
	tricorn_iterations(keysym, fractal);
	return (1);
}
